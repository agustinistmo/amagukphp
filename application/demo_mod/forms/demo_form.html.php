...
<ul class="nav nav-tabs">
  ...
  <li class="active"><a href="<?php print MGK_HOME?>/index.php/demo/form">Captura</a></li>
</ul>
...
<div id="div_<?php print $this->getName();?>">
		...
		<fieldset>		
			...
			<div class="col-lg-10">
			<input maxlength="10" class="form-control" type="text" name="tipo_usuario_id" id="tipo_usuario_id" placeholder="Tipo_usuario_id" value="<?php print $this->bean->getTipo_usuario_id();?>" style="width: 120px"  >
			</div>
			</div>
			...
			<div class="col-lg-10">
			<input maxlength="16" class="form-control" type="text" name="tipo_usuario_nombre" id="tipo_usuario_nombre" placeholder="Tipo_usuario_nombre" value="<?php print $this->bean->getTipo_usuario_nombre();?>" style="width: 200px"  >
			</div>
			</div>
			...
			<div class="col-lg-10">
			<input maxlength="83" class="form-control" type="text" name="descripcion" id="descripcion" placeholder="Descripcion" value="<?php print $this->bean->getDescripcion();?>" style="width: 490px"  >
			</div>
			</div>
