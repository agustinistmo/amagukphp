...
/**
 * Conexión con mysql usando mssql
 * @author http://amagukmx.wordpress.com/
 *
 */	
class Amaguk_mssql_connection extends Amaguk_database_connection {
	...
	public function connect() {
		...
		$this->link_identifier = mssql_connect( $this->server , $this->user , $this->password, $this->data_base_name );
		if ( !$this->link_identifier)
			die('###Amaguk_mssql_connection###--001-- ERROR DE CONEXION');
	...
	public function fetch_object() {
		// TODO Auto-generated method stub
		$this->data = mssql_fetch_object( $this->result);		
		return $this->data;		
...
/* (non-PHPdoc)
	...
	public function query( $query ) {
		...
		$this->result = mssql_query( $this->link_identifier , $this->query);
		$this->query="";
...
/* (non-PHPdoc)
	...
	public function insert_id(){
		return mssql_insert_id($this->link_identifier);		
	}
